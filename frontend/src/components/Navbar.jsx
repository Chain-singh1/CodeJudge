          ...
          <div className="hidden md:block relative" ref={dropdownRef}>
            ...
            {dropdownOpen && (
              <div className="absolute right-0 top-full mt-2 w-48 bg-[#1a1d27] border border-gray-700 rounded-xl shadow-xl overflow-hidden z-50">
                ...
                <div className="py-1">
                  <Link to="/profile" className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-300 hover:bg-gray-800 hover:text-white transition-colors">
                  ...
                  <Link to="/settings" className="flex items-center gap-3 px-4 py-2.5 text-sm text-gray-300 hover:bg-gray-800 hover:text-white transition-colors">
                  ...
                  <button onClick={handleLogout} className="w-full flex items-center gap-3 px-4 py-2.5 text-sm text-red-400 hover:bg-red-950 hover:text-red-300 transition-colors">
      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-[#1a1d27] border-b border-gray-800 z-30 relative">
            ...
            {navLinks.map(({ to, label }) => (
              <Link
                ...
                className={`flex items-center px-4 py-3 text-sm transition-colors ${
                  isActive(to) ? 'text-white bg-gray-800' : 'text-gray-400 hover:text-white hover:bg-gray-800'
                }`}
              >
                {label}
              </Link>
          ...
          <div className="border-t border-gray-800 py-2">
            <Link to="/profile" className="flex items-center px-4 py-3 text-sm text-gray-400 hover:text-white hover:bg-gray-800 transition-colors">Profile</Link>
            <Link to="/settings" className="flex items-center px-4 py-3 text-sm text-gray-400 hover:text-white hover:bg-gray-800 transition-colors">Settings</Link>
            <button onClick={handleLogout} className="w-full flex items-center px-4 py-3 text-sm text-red-400 hover:bg-red-950 transition-colors">Logout</button>
          </div>
        </div>
      )}
    </>
