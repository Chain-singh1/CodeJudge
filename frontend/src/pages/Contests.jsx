    ...
    <div className="min-h-screen w-full bg-[#0f1117] text-white">
      ...
      <div className="max-w-7xl mx-auto px-3 py-4">
        <div className="mb-6">
          ...
          <p className="text-gray-400 text-sm mt-1">Compete and climb the leaderboard</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center text-gray-500 py-24 text-sm">No contests available</div>
        ) : (
                  ...
                  <div className="flex items-start justify-between gap-4">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        <h2 className="font-semibold text-white text-lg">{contest.title}</h2>
                        <span className={`text-xs px-2.5 py-1 rounded-lg font-medium capitalize ${statusStyle[status]}`}>
                          {status}
                        </span>
                      </div>
                    ...
                    >
                      {status === 'active' ? 'Enter →' : status === 'upcoming' ? 'Upcoming' : 'View'}
                    </button>
                  </div>
                </div>
              )
